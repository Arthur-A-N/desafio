...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(primos(20));
        System.out.println(chamaPrimosRecursivai(20));
    }

    public static List<Integer> chamaPrimosRecursivai(int arg) {
        if (arg < 2) {
            throw new IllegalArgumentException("arg precisa ser >= 2 ");
        }
        Main m = new Main();
    ...
    public static int chamaFibonacciRecursiva(int arg) {
        if (arg < 0) {
            throw new IllegalArgumentException("arg precisa ser >= 0 ");
        }
        int atual = 1;
        int anterior = 0;
